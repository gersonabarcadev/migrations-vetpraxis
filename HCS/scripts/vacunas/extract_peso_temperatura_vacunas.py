...
# -*- coding: utf-8 -*-
"""
Script para extraer PESO y TEMPERATURA del campo NOTE en vacunas
Adaptado del script de extracción de diagnósticos
"""
...
def process_vacunas_with_peso_temp(input_file=None, output_dir=None):
    ...
    output_file = os.path.join(output_dir, "vacunas_with_peso_temp.xlsx")
    
    print("[PROC] EXTRAYENDO PESO Y TEMPERATURA DE VACUNAS")
    print("="*60)
    ...
    with pd.ExcelWriter(output_file, engine='openpyxl') as writer:
        ...
        df_clean.to_excel(writer, sheet_name='Vacunas_Con_Peso_Temp', index=False)
...
def main():
    ...
    print("[>>] EXTRAYENDO PESO Y TEMPERATURA DE VACUNAS")
    ...
    try:
        result = process_vacunas_with_peso_temp(input_file, output_dir)
